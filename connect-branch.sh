...
az network vpn-gateway connection vpn-site-link-conn add --name on-prem-link-conn --connection-name onprem-connection --vpn-site-link onprem -g vwan-microhack-hub-rg --gateway-name microhack-we-hub-vng
