...
az network vpn-gateway connection create --gateway-name microhack-we-hub-vng --name onprem-connection --vpn-site-link onprem -g vwan-microhack-hub-rg --shared-key $sharedkey --enable-bgp true --no-wait
